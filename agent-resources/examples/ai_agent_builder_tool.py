...
async def main():
    st.title("⚡️ Archon - The Ultimate Agent Builder 🤖")
    st.write("🛠️ **Tell me your dream AI agent, and I'll make it real with Pydantic AI!**")
    ...
    pydantic_ai = st.text_area("Pydantic AI Code", height=150, key="pydantic_ai_rag")
    if pydantic_ai:
        st.write("**Configuration Preview:**")
        st.code(pydantic_ai, language="python")
